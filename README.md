...
- 追加 Login Node、Slurm バックアップコントローラ、Open OnDemand、Spack、ParaView、Enroot / Pyxis、PAM、Healthcheck、監視をオプションで有効化できます。
...
| `install_application` | 共有領域に ParaView 5.11.2 をインストールします。 |
