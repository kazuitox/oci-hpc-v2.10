...
- 追加 Login Node、Slurm バックアップコントローラ、Open OnDemand、Spack、OpenFOAM、Enroot / Pyxis、PAM、Healthcheck、監視をオプションで有効化できます。
...
| `install_application` | 共有領域に追加アプリケーションをインストールします。現時点では OpenFOAM v2312 を選択できます。 |
