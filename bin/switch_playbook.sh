...
declare -a PAIRS=(
  ...
  "${BASE_DIR}/roles/nfs-client/tasks/ubuntu.yml:${BASE_DIR}/roles/nfs-client/tasks/lite_ubuntu.yml"
  "${BASE_DIR}/roles/sssd/tasks/el-8.yml:${BASE_DIR}/roles/sssd/tasks/lite_el-8.yml"
  "${BASE_DIR}/roles/sssd/tasks/debian.yml:${BASE_DIR}/roles/sssd/tasks/lite_debian.yml"
