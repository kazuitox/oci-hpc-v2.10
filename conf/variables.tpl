...
variable "use_local_block_volume" { default = ##USE_LOCAL_BLOCK_VOLUME## }
variable "local_block_volume_size" { default = "##LOCAL_BLOCK_VOLUME_SIZE##" }
variable "local_block_volume_performance" { default = "##LOCAL_BLOCK_VOLUME_PERFORMANCE##" }
variable "local_block_volume_mount_point" { default = "##LOCAL_BLOCK_VOLUME_MOUNT_POINT##" }
...
variable "install_application" { default = ${install_application} }
variable "install_openfoam" { default = ${install_openfoam} }
variable "application" { default = "${application}" }
variable "application_version" { default = "${application_version}" }
variable "openfoam_version" { default = "${openfoam_version}" }
variable "install_paraview" { default = ${install_paraview} }
variable "paraview_version" { default = "${paraview_version}" }
